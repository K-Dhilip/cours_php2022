...
<<<<<<< HEAD
                    ...
                    <div class="col-sm-12 col-md-3">
                        ...
                        ?>
                        <p>Ici la variable $b nous renvoie le booléen 1 qui signifie vrai. Dans le cas où la variable doit renvoyer un booléen faux (False) , il ya aura une chaîne vide à la place de 0.</p>
                    </div>
                    <hr>
                    <div class="col-sm-12">
...
<<<<<<< HEAD
                        ...
                        <p>Attention, une erreur classique dans l'ecriture des expressions conditionnelles consiste à confondre l'opérateur de comparaison == avec l'opérateur d'affectation =. L'usage des parenthèses dans la rédaction des expressions booléennes est souvent indispensable et toujours recommandé pour éviter les problèmes liés à l'ordre d'évaluation des opérateurs.</p>
                    </div><!-- fin de la colonne -->
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <p>Les chaînes de caractères sont avec les nombres les types de données les plus manipulées sur un site web. De surcroît, dans les échanges entre le client et le serveur au moyen de formulaires, toutes les données sont transmises sous forme de chaînes, d'où leur importance.</p>
                        <p>Une chaîne de caractères est une suite de caractères alphanumérique contenue entre des guillemets simples (apostrophes) ou doubles. Si une chaîne contient une variable, celle-ci est évaluée et sa valeur incorporée à la chaîne uniquement si vous utilisez des guillemets et non des apostrophes. <br></p>
                        <?php
                            $vartest = "éléphants";
                            echo "<p class=\"alert alert-success w-75 text-center mx-auto\">J'aime les $vartest !</p>"; 

                            // var_dump($vartest); // var_dump affiche les informations structurées 
                        ?>
                        <ul>
                            <li>$a = 'PHP';</li>
                            <li>$b = 'MYSQL';</li>
